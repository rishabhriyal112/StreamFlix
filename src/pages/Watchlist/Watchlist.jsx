        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          {watchlist.length === 0 ? (
            <div className="text-center py-20">
              <h2 className="text-2xl text-gray-400 mb-4">Your watchlist is empty</h2>
              <p className="text-gray-500 mb-8">Add movies and TV shows to watch them later</p>
              <button 
                onClick={() => navigate('/')}
                  ...
                  <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex flex-col justify-end p-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 bg-red-600 text-white py-2 px-3 rounded text-xs hover:bg-red-700 transition-colors flex items-center justify-center gap-1"
                      >
